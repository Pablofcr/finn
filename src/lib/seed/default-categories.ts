...
export const defaultCategories: DefaultCategory[] = [
  ...
  },
  {
    ...
    color: '#8b5cf6',
    type: 'EXPENSE',
    keywords: ['iptu', 'gás', 'reforma', 'obra', 'móveis', 'eletrodoméstico', 'decoração', 'limpeza'],
    subcategories: [
      { name: 'Aluguel', icon: 'key', keywords: ['aluguel', 'aluguéis', 'inquilino', 'locação', 'imobiliária'] },
      { name: 'Condomínio', icon: 'building-2', keywords: ['condomínio', 'condomínios', 'taxa condominial', 'síndico'] },
