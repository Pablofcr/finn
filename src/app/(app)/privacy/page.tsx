      ...
      <Card>
        <CardContent className="pt-6 pb-6 prose prose-sm dark:prose-invert max-w-none">
          ...
          <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-5">
            ...
            <li><strong>Dados do Telegram:</strong> ID do chat para envio de alertas (não armazenamos conversas)</li>
          ...
          <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-5">
            ...
            <li>Enviar lembretes de pagamento pelo Telegram</li>
          ...
          <ul className="text-sm text-muted-foreground space-y-1 list-disc pl-5">
            ...
            <li><strong>Consentimento:</strong> para funcionalidades opcionais como insights por IA e integração com Telegram</li>
