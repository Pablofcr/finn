...
const FEATURES = [
  ...
  { name: 'Contas bancárias', free: '1', pro: 'Ilimitadas', icon: Wallet },
  { name: 'Orçamentos', free: '2', pro: 'Ilimitados', icon: PieChart },
  ...
  { name: 'Bot Telegram — áudio', free: '2/mês', pro: 'Ilimitados', icon: Mic },
  { name: 'Bot Telegram — foto de cupom', free: '2/mês', pro: 'Ilimitadas', icon: Camera },
